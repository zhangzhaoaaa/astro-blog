const socialIcons = {
  ...
  X: `<svg class="w-5 h-5 bg-gray-400 dark:bg-gray-500 hover:bg-gray-500 dark:hover:bg-gray-400" style="mask-image: url(&quot;https://d3gk2c5xim1je2.cloudfront.net/v7.1.0/brands/x-twitter.svg&quot;); mask-repeat: no-repeat; mask-position: center center;"></svg>`,
  Twitter: `<svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon-tabler"
      stroke-linecap="round"
